...
class UpdateGroupUseCase extends UseCase<bool, GroupModel> {
  final GroupsRepository groupsRepository;

  UpdateGroupUseCase({required this.groupsRepository});

  @override
  Future<Either<ServerFailure, bool>> call(params) async {
    return await groupsRepository.updateGroup(params);
  }
}
